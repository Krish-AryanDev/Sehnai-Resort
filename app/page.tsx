...
const services = [
  {
    tag: "01 — Marriage Hall",
    title: "Celebrate Love\nin Grand Style",
    description:
      "Our magnificent marriage hall is designed to be the perfect backdrop for your most cherished moments. With elegant décor, world-class catering, and a dedicated events team, we ensure your wedding is nothing short of extraordinary.",
    features: ["Up to 600 Guests", "In-house Catering", "Full AV Setup", "Dedicated Coordinator"],
  ...
  },
  {
    ...
    description:
      "Step into a world of culinary artistry. Our restaurant blends rich tradition with modern gastronomy — every dish is a masterpiece, every meal an occasion. Whether an intimate dinner or a large gathering, we cater to every palate.",
    features: ["Authentic Indian Cuisine", "Family-Friendly Menu", "Scenic View", "Room Service Available"],
    cta: "View the Menu",
    path: "/restaurant",
    image:
  ...
  },
  {
    ...
    title: "Rest in\nAbsolute Luxury",
    description:
      "Our boutique hotel offers 12 premium rooms, each thoughtfully designed with comfort and elegance in mind. Enjoy world-class amenities, attentive service, and a peaceful sanctuary — just moments from everything you need.",
    features: ["12 Premium Rooms", "24/7 Room Service", "Free Wi-Fi & Parking", "Daily Housekeeping"],
    cta: "See Our Rooms",
    path: "/hotel",
    image:
...
const stats = [
  ...
  { icon: Users, value: "200+", label: "Happy Celebrations" },
  { icon: UtensilsCrossed, value: "50+", label: "Menu Items" },
  { icon: BedDouble, value: "12", label: "Premium Rooms" },
];
  ...
  return (
    <div style={{ backgroundColor: "#07070d" }}>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <FadeIn delay={0.1}>
            ...
            >
              ...
              <span className="italic text-[#C9A84C]">One Legendary Address</span>
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            ...
            >
              From the grandest wedding celebrations to intimate dining experiences and luxurious overnight stays — Sehnai Resort is built to be the most memorable address in your life's most important moments.
            </p>
          </FadeIn>
        </div>
      </section>
        ...
        {services.map((service, index) => {
          ...
          return (
            <div
              ...
              style={{
                borderBottom:
                  index < services.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none",
              }}
            >
              <div
      ...
      <section
        ...
        style={{
          background: "linear-gradient(135deg, #0e0e18 0%, #1a1506 50%, #0e0e18 100%)",
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <FadeIn delay={0.1}>
            ...
            >
              ...
              <span className="italic text-[#C9A84C]">Perfect Experience?</span>
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            ...
            >
              Contact our team today and let us craft a bespoke experience tailored to your vision, your story, and your occasion.
            </p>
          </FadeIn>
