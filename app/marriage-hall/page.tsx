...
export default function MarriageHallPage() {
  return (
    <div style={{ backgroundColor: "#07070d" }}>
      <PageHero
        eyebrow="Sehnai Resort"
        title="Marriage Hall"
        description="A venue as grand as your love story. Where every detail is perfected and every moment becomes a memory."
              ...
              <div className="relative">
                ...
                >
                  <span
                    ...
                    style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.8rem", fontWeight: 400, lineHeight: 1 }}
                  >
                    600
                  </span>
                  <span
                    className="text-black/70 font-inter uppercase"
                    style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.55rem", letterSpacing: "0.18em", fontWeight: 600, marginTop: "4px" }}
                  >
                    Guest Capacity
                  </span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <FadeIn>
            <div className="text-center mb-14">
              ...
              >
                Everything You Need,{" "}
                <span className="italic text-[#C9A84C]">All Under One Roof</span>
              </h2>
            </div>
          </FadeIn>
            ...
            {packages.map((pkg, i) => (
              <FadeIn key={pkg.name} delay={i * 0.1}>
                <div
                  ...
                  style={{
                    backgroundColor: pkg.highlight ? "rgba(201,168,76,0.06)" : "#0d0d16",
                    border: pkg.highlight ? "1px solid rgba(201,168,76,0.4)" : "1px solid rgba(255,255,255,0.06)",
                  }}
                >
                  {pkg.highlight && (
                    <div className="absolute -top-px left-0 right-0 h-0.5" style={{ backgroundColor: "#C9A84C" }} />
                  )}
                  {pkg.highlight && (
                    <div
                      className="absolute top-4 right-4 font-inter uppercase"
                      style={{
                        fontFamily: "'Inter', sans-serif",
                        fontSize: "0.55rem",
                  ...
                  <div className="mb-6">
                    ...
                    <p
                      className="text-[#C9A84C] font-inter italic"
                  ...
                  <p
                    className="text-white/35 font-inter mb-1"
                    style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.72rem", letterSpacing: "0.1em" }}
                  >
                    {pkg.capacity}
                  </p>
                  <p
                    className="text-[#C9A84C] font-playfair mb-6"
                    style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.1rem", fontWeight: 400 }}
                  >
                    {pkg.price}
                  </p>
                  ...
                  <ul className="flex flex-col gap-2.5 mb-8 flex-1">
                    {pkg.items.map((item) => (
                      <li
                        ...
                        style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.8rem", color: "rgba(255,255,255,0.5)", fontWeight: 300 }}
                      >
                  ...
                  <button
                    className="w-full py-3 font-inter flex items-center justify-center gap-2 transition-all duration-300 group"
                    style={{
                      fontFamily: "'Inter', sans-serif",
                      fontSize: "0.68rem",
                      letterSpacing: "0.22em",
                      ...
                      color: pkg.highlight ? "#000" : "#C9A84C",
                      border: pkg.highlight ? "none" : "1px solid rgba(201,168,76,0.4)",
                    }}
                  >
                    Book This Package
      ...
      <ContactCTA
        ...
        description="Contact our wedding team today and start planning the celebration of a lifetime."
