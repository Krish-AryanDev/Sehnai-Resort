  ...
  return (
    <div style={{ backgroundColor: "#07070d" }}>
      <PageHero
        ...
        title="The Hotel"
        description="12 premium rooms — each a world of comfort, elegance, and personalized service."
        image="https://images.unsplash.com/photo-1776763018821-8feeaeeee0a5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBob3RlbCUyMHJvb20lMjBpbnRlcmlvciUyMGVsZWdhbnR8ZW58MXx8fHwxNzc4NDgyNTc3fDA&ixlib=rb-4.1.0&q=80&w=1080"
      />
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: "#07070d" }}>
        <div className="max-w-4xl mx-auto px-6 md:px-10 text-center">
          <FadeIn>
            ...
            >
              Where Every Detail{" "}
              <span className="italic text-[#C9A84C]">Speaks of Luxury</span>
            </h2>
            <p
              className="text-white/45 font-inter"
              style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.95rem", lineHeight: 1.85, fontWeight: 300 }}
            >
            ...
            {rooms.map((room, i) => (
              <FadeIn key={room.type} delay={i * 0.1}>
                <div
                  ...
                  style={{
                    backgroundColor: room.highlight ? "rgba(201,168,76,0.04)" : "#0a0a13",
                    border: room.highlight ? "1px solid rgba(201,168,76,0.35)" : "1px solid rgba(255,255,255,0.05)",
                  }}
                >
                  <div className="relative overflow-hidden" style={{ aspectRatio: "4/3" }}>
                    ...
                    {room.highlight && (
                      <div
                        className="absolute top-3 right-3 font-inter uppercase"
                        style={{
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3
                          ...
                          style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.2rem", fontWeight: 400 }}
                        >
                          {room.type}
                        </h3>
                        <p
                          className="text-white/35 font-inter mt-1"
                      ...
                      <p
                        className="text-[#C9A84C] font-playfair text-right"
                        style={{ fontFamily: "'Playfair Display', serif", fontSize: "0.95rem", fontWeight: 400, lineHeight: 1.3 }}
                      >
                        {room.price}
                      </p>
                    </div>
                    ...
                    <p
                      className="text-white/40 font-inter mb-5 flex-1"
                      style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.8rem", lineHeight: 1.75, fontWeight: 300 }}
                    >
                      {room.description}
                    </p>
                    ...
                    <ul className="flex flex-col gap-2 mb-6">
                      {room.features.map((feat) => (
                        <li
                          ...
                          style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.75rem", color: "rgba(255,255,255,0.45)", fontWeight: 300 }}
                        >
                    ...
                    <button
                      className="w-full py-3 font-inter flex items-center justify-center gap-2 group transition-all duration-300"
                      style={{
                        fontFamily: "'Inter', sans-serif",
                        fontSize: "0.68rem",
                        letterSpacing: "0.2em",
                        ...
                        backgroundColor: room.highlight ? "#C9A84C" : "transparent",
                        color: room.highlight ? "#000" : "#C9A84C",
                        border: room.highlight ? "none" : "1px solid rgba(201,168,76,0.35)",
                      }}
                    >
                      Book This Room
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          <FadeIn>
            <div className="text-center mb-14">
              ...
              >
                Every Comfort,{" "}
                <span className="italic text-[#C9A84C]">Thoughtfully Provided</span>
              </h2>
            </div>
          </FadeIn>
              ...
              return (
                <FadeIn key={item.label} delay={i * 0.07}>
                  <div className="p-6 flex flex-col gap-3" style={{ backgroundColor: "#0d0d16", border: "1px solid rgba(255,255,255,0.05)" }}>
                    ...
                    <h3
                      className="text-white font-playfair"
                      style={{ fontFamily: "'Playfair Display', serif", fontSize: "0.95rem", fontWeight: 400 }}
                    >
                      {item.label}
                    </h3>
                    <p
                      className="text-white/35 font-inter"
                      style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.78rem", lineHeight: 1.7, fontWeight: 300 }}
                    >
                      {item.desc}
                    </p>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 w-full">
            <FadeIn>
              <p
                ...
                style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(1.3rem, 3vw, 2rem)", fontWeight: 400, maxWidth: "500px", lineHeight: 1.4 }}
              >
      ...
      <ContactCTA
        ...
        description="Call us directly or send an enquiry and our reservations team will assist you promptly."
