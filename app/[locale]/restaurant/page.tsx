  ...
  return (
    <div style={{ backgroundColor: "#07070d" }}>
            ...
            <FadeIn delay={0.1}>
              <div>
                ...
                <h2 className="text-white font-playfair mb-5" style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(1.8rem, 3vw, 2.6rem)", fontWeight: 400, lineHeight: 1.2 }}>
                  Crafted with Passion, <span className="italic text-[#C9A84C]">Served with Love</span>
                </h2>
                ...
                <p className="text-white/45 font-inter mb-5" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.85, fontWeight: 300 }}>
                  At Shehnai Resort, our culinary team brings together generations of knowledge and the finest ingredients from around the world. We believe that great food is not just nourishment — it is an experience.
                </p>
              ...
              <FadeIn key={cat.name} delay={i * 0.09}>
                <div className="p-7" style={{ backgroundColor: "#0a0a13", border: "1px solid rgba(255,255,255,0.05)" }}>
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <h3 className="text-white font-playfair" style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.1rem", fontWeight: 400 }}>{cat.name}</h3>
                  </div>
                  <div className="w-6 h-px bg-[#C9A84C]/40 mb-4" />
                  <ul className="flex flex-col gap-2.5">
                    {cat.items.map((item) => (
                      <li key={item} className="flex items-start gap-2 font-inter" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.8rem", color: "rgba(255,255,255,0.45)", fontWeight: 300, lineHeight: 1.5 }}>
              ...
              return (
                <FadeIn key={item.title} delay={i * 0.08}>
                  <div className="flex gap-5 p-7" style={{ backgroundColor: "#0d0d16", border: "1px solid rgba(255,255,255,0.05)" }}>
                    ...
                    <div>
                      <h3 className="text-white font-playfair mb-2" style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.1rem", fontWeight: 400 }}>{item.title}</h3>
                      <p className="text-white/40 font-inter whitespace-pre-line" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.82rem", lineHeight: 1.75, fontWeight: 300 }}>{item.desc}</p>
                    </div>
                  </div>
                </FadeIn>
              );
      ...
      <section className="relative overflow-hidden" style={{ height: "380px" }}>
        ...
        />
        <div className="absolute inset-0 bg-linear-to-r from-black/70 to-transparent pointer-events-none" />
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-6 md:px-10 w-full">
            <FadeIn>
              <p className="text-[#C9A84C] font-playfair italic" style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(1.3rem, 3vw, 2.2rem)", fontWeight: 400, maxWidth: "500px", lineHeight: 1.4 }}>
                &quot;Good food is the foundation of genuine happiness.&quot;
              </p>
              <p className="text-white/35 font-inter mt-3" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.78rem", letterSpacing: "0.15em" }}>— Auguste Escoffier</p>
            </FadeIn>
          </div>
        </div>
      </section>
